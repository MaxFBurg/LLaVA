...
# python -m llava.eval.run_llava_qa  --model-name model_weights/ --image-file "https://llava-vl.github.io/static/images/view.jpg,https://llava-vl.github.io/static/images/view.jpg" --query "What are the things I should be cautious about when I visit here?"
